 ...
 * @author vroom
 */
public class AdminSalesReportPage extends javax.swing.JFrame {
    public String loggedInUser;

    /**
     * Creates new form SalesReportPage_SM
     */
    public AdminSalesReportPage(String loggedInUser) {
        initComponents();
        loadItemsToTable();
...
try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminSalesReportPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminSalesReportPage().setVisible(true);
            }
        });
    }
